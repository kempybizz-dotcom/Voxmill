...
- If query uses "that", "it", "them" etc., infer referent from conversation history
- Maintain conversational flow, avoid repeating information already provided
- If query is a follow-up, provide delta/incremental information"""
